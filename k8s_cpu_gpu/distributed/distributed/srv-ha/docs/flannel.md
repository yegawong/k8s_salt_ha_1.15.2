...
6.设置Flannel系统服务
```
[root@linux-node1 ~]# vim /lib/systemd/system/flannel.service
[Unit]
...
复制系统服务脚本到其它节点上
# scp /lib/systemd/system/flannel.service 192.168.56.12:/lib/systemd/system/
# scp /lib/systemd/system/flannel.service 192.168.56.13:/lib/systemd/system/
```
...
## 配置Docker使用Flannel
```
[root@linux-node1 ~]# vim /lib/systemd/system/docker.service
...
将配置复制到另外两个阶段
```
# scp /lib/systemd/system/docker.service 192.168.56.12:/lib/systemd/system/
# scp /lib/systemd/system/docker.service 192.168.56.13:/lib/systemd/system/
```
重启Docker
```
[root@linux-node1 ~]# systemctl daemon-reload
